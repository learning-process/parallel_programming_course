...
"C:\Program Files\Microsoft MPI\Bin\mpiexec.exe" -np 4 build\bin\mpi_func_tests.exe  --gtest_also_run_disabled_tests --gtest_repeat=10 --gtest_recreate_environments_when_repeating || exit 1
