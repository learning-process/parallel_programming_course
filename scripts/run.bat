...
if "%CLANG_BUILD%" NEQ "1" "C:\Program Files\Microsoft MPI\Bin\mpiexec.exe" -np 4 build\bin\sample_mpi.exe
if "%CLANG_BUILD%" NEQ "1" "C:\Program Files\Microsoft MPI\Bin\mpiexec.exe" -np 4 build\bin\sample_mpi_boost.exe
