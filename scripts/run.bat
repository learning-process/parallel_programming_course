...
"C:\Program Files\Microsoft MPI\Bin\mpiexec.exe" -np 4 build\bin\sample_mpi.exe
"C:\Program Files\Microsoft MPI\Bin\mpiexec.exe" -np 4 build\bin\sample_mpi_boost.exe
build\bin\sample_omp.exe
build\bin\sample_stl.exe
build\bin\sample_tbb.exe

"C:\Program Files\Microsoft MPI\Bin\mpiexec.exe" -np 4 build\bin\mpi_func_tests.exe --gtest_repeat=10 || exit 1
build\bin\mpi_func_tests.exe || exit 1
