...
ExternalProject_Add(ppc_boost
        ...
        -D MPI_C_INCLUDE_PATH=${MPI_C_INCLUDE_PATH} -D MPI_C_LIBRARIES=${MPI_C_LIBRARIES} -D MPI_CXX_INCLUDE_PATH=${MPI_CXX_INCLUDE_PATH} -D MPI_CXX_LIBRARIES=${MPI_CXX_LIBRARIES}
